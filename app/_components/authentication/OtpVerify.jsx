...
<Button
  type="submit"
  className="w-full text-white font-medium  cursor-pointer py-2 px-6 rounded-md bg-gradient-to-r from-[#933FFE] to-[#18C8FF] hover:opacity-90 transition-all duration-300"
>
